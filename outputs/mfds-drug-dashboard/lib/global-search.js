...
const { valueOf, includesText, MemoryCache } = require("./utils");
...
const globalMemoryCache = new MemoryCache(GLOBAL_CACHE_LIMIT, GLOBAL_CACHE_TTL_MS);
...
function includesKeyword(value, keyword) {
  return includesText(value, keyword, true);
}
...
async function globalSearch(query = {}) {
  ...
  const searchPromise = runGlobalSearch(keyword)
    .then((payload) => globalMemoryCache.set(cacheKey, payload))
